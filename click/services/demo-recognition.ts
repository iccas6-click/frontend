...
function pill(
  ...
  return {
    ...
    dosage,
    category: '알약',
    productName: `${name} ${dosage}`.trim(),
    ingredients,
    analysisNames: [...ingredients, ...extraNames, name],
  };
}
...
const PILL_DEMOS: DemoRecognitionSet[] = [
  {
    ...
    category: '알약',
    items: [
      pill('demo-pill-warfarin', '와파린정', '5mg', ['와파린'], ['warfarin']),
      pill('demo-pill-aspirin', '아스피린프로텍트정', '100mg', ['아스피린'], ['aspirin']),
      pill('demo-pill-ibuprofen', '이부프로펜정', '200mg', ['이부프로펜'], ['ibuprofen']),
    ],
  },
  {
    id: 'metabolic-pill',
...
const SUPPLEMENT_DEMOS: DemoRecognitionSet[] = [
  {
    ...
    category: '건강기능식품 라벨',
    items: [
      supplement('demo-supp-omega3', '오메가-3', ['EPA 및 DHA 함유 유지'], 'EPA/DHA 1,000mg', ['오메가-3'], ['오메가-3']),
      supplement('demo-supp-ginkgo', '은행잎 추출물', ['은행잎'], '플라보놀배당체 28mg', ['은행잎', 'Ginkgo']),
      supplement('demo-supp-garlic', '마늘 추출물', ['마늘'], '마늘분말 500mg', ['Garlic']),
    ],
  },
  {
