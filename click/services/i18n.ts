...
const STRINGS: Record<TranslationKey, Record<AppLanguage, string>> = {
  ...
  standardBody: {
    ko: '요양사 · 보호자',
    en: 'Caregivers · guardians',
    fr: 'Aidants · proches',
  },
  lowVisionBody: {
    ko: '큰 버튼 · 높은 대비',
    en: 'Large buttons · high contrast',
    fr: 'Grands boutons · contraste élevé',
  },
  prescriptionRecognition: {
    ko: '처방전·약봉투 인식',
    en: 'Prescription and medicine bag recognition',
    fr: 'Reconnaissance d’ordonnance et de sachet',
  },
  prescriptionRecognitionInfo: {
  ...
  screenContrast: {
    ko: '화면 대비',
    en: 'Screen contrast',
    fr: 'Contraste de l’écran',
  },
  diagnosticLogs: {
    ko: '진단 로그',
    en: 'Diagnostic logs',
    fr: 'Journaux de diagnostic',
  },
  medicationReminder: {
    ko: '복용 알림',
  ...
  caregiverSharing: {
    ko: '보호자 공유',
    en: 'Caregiver sharing',
    fr: 'Partage avec un aidant',
  },
  ...
  interactionAnalysis: {
    ...
    fr: 'Analyse des interactions',
  },
  oneMinuteCheck: {
    ko: '복용 전 1분 체크',
    en: '1-minute check before use',
    fr: 'Vérification en 1 minute',
  },
  startRecognition: {
    ko: '인식 시작하기',
    en: 'Start scanning',
  ...
  showMoreFive: {
    ko: '5개 더보기',
    en: 'Show 5 more',
    fr: 'Afficher 5 de plus',
  },
  resumeRecognition: {
    ko: '하던 인식이 있어요',
    en: 'You have a scan in progress',
    fr: 'Un scan est en cours',
  },
  prescriptionCount: {
    ko: '처방약 {count}개',
    en: '{count} prescriptions',
    fr: '{count} médicaments',
  },
  supplementCount: {
    ko: '건강기능식품 {count}개',
    en: '{count} supplements',
    fr: '{count} compléments',
  },
  ...
  selectCaptureItem: {
    ko: '촬영할 항목 선택',
    en: 'Choose what to scan',
    fr: 'Choisir quoi scanner',
  },
  selectCaptureSubtitle: {
  ...
  capturePrescription: {
    ko: '처방전·약봉투 촬영',
    en: 'Scan prescription or prescription bag',
    fr: 'Scanner ordonnance ou sachet',
  },
  captureSupplement: {
    ko: '건강기능식품 촬영',
    en: 'Scan supplement',
    fr: 'Scanner un complément',
  },
  capturePrescriptionSubtitle: {
    ko: '조제약 봉투, 처방전, 복약 안내문',
    en: 'prescription bag, prescription, or medication guide',
    fr: 'Sachet, ordonnance ou notice de prise',
  },
  captureSupplementSubtitle: {
    ko: '비타민, 오메가3, 유산균 등 제품 라벨',
    en: 'Product labels such as vitamins, omega-3, probiotics',
    fr: 'Étiquettes de vitamines, oméga-3, probiotiques, etc.',
  },
  addPrescription: {
    ko: '처방전·약봉투 추가',
    en: 'Add prescription or prescription bag',
    fr: 'Ajouter ordonnance ou sachet',
  },
  addSupplement: {
    ko: '건강기능식품 추가',
    en: 'Add supplement',
    fr: 'Ajouter un complément',
  },
  chooseAddMethod: {
    ko: '{label}을 어떻게 추가할까요?',
    en: 'How would you like to add {label}?',
    fr: 'Comment ajouter {label} ?',
  },
  captureNew: {
    ko: '새 {label} 촬영하기',
    en: 'Take a new photo of {label}',
    fr: 'Prendre une nouvelle photo de {label}',
  },
  chooseFromGallery: {
    ko: '갤러리에서 가져오기',
  ...
  chooseFromRecords: {
    ko: '기존 기록에서 선택하기',
    en: 'Choose from saved records',
    fr: 'Choisir dans l’historique',
  },
  loadSampleResults: {
    ko: '예시 결과 불러오기',
    en: 'Load sample results',
    fr: 'Charger des exemples',
  },
  existingRecords: {
    ko: '기존 {label} 기록',
    en: 'Saved {label} records',
    fr: 'Historique {label}',
  },
  noReusableRecords: {
    ko: '아직 재사용할 {label} 기록이 없어요',
    en: 'No reusable {label} records yet',
    fr: 'Aucun historique {label} réutilisable',
  },
  noReusableRecordsBody: {
  ...
  cameraPermissionBody: {
    ...
    en: 'Allow access so you can photograph prescriptions, prescription bag, and supplement labels.',
  ...
  capturePrescriptionA11y: {
    ko: '처방전 또는 약봉투 촬영하기',
    en: 'Take a photo of a prescription or prescription bag',
    fr: 'Photographier une ordonnance ou un sachet',
  },
  captureSupplementA11y: {
    ko: '건강기능식품 촬영하기',
    en: 'Take a photo of a supplement',
    fr: 'Photographier un complément',
  },
  capturePrescriptionGuide: {
    ko: '약품명·용량이 보이게 전체를 촬영하세요.',
    en: 'Capture the full document so medicine names and dosages are visible.',
    fr: 'Cadrez tout le document pour voir noms et doses.',
  },
  captureSupplementGuide: {
    ko: '제품명과 성분표가 보이게 촬영하세요.',
    en: 'Make the product name and ingredient panel visible.',
    fr: 'Rendez visibles le nom du produit et la liste des ingrédients.',
  },
  steadyShotHint: {
    ko: '흔들리지 않게 정면에서 촬영해 주세요',
    en: 'Hold steady and shoot from the front',
    fr: 'Tenez l’appareil stable et photographiez de face',
  },
  labelTipTitle: {
    ko: '라벨 글자가 중요해요',
    en: 'Label text matters',
    fr: 'Le texte de l’étiquette compte',
  },
  pillTipTitle: {
    ko: '약품명이 보이게 촬영해요',
    en: 'Make the medicine name visible',
    fr: 'Rendez le nom du médicament lisible',
  },
  labelTipBody: {
  ...
  pillCandidateReview: {
    ko: '약 후보 확인',
    en: 'Review medicine candidates',
    fr: 'Vérifier les candidats',
  },
  recognizedCategory: {
    ko: '인식된 {label}',
    en: 'Scanned {label}',
  ...
  addMissingCategory: {
    ko: '목록에 없는 {label} 직접 추가',
    en: 'Add missing {label}\nmanually',
    fr: 'Ajouter {label}\nmanuellement',
  },
  originalPhotoMissing: {
    ko: '원본 사진 없음',
    en: 'Original photo unavailable',
    fr: 'Photo originale indisponible',
  },
  isThisPillCorrect: {
    ko: '표시된 약 후보가 맞나요?',
    en: 'Is the highlighted medicine correct?',
    fr: 'Le médicament indiqué est-il correct ?',
  },
  previousCandidate: {
    ko: '이전 약 후보',
    en: 'Previous candidate',
    fr: 'Candidat précédent',
  },
  nextCandidate: {
    ko: '다음 약 후보',
    en: 'Next candidate',
  ...
  chooseClosestProduct: {
    ko: '문서 내용과 가장 가까운 제품을 선택',
    en: 'Choose the product closest to the document',
    fr: 'Choisissez le produit le plus proche du document',
  },
  edit: { ko: '수정', en: 'Edit', fr: 'Modifier' },
  ingredientInfoNeeded: {
    ko: '성분 정보 확인 필요',
    en: 'Ingredient info needed',
    fr: 'Ingrédients à vérifier',
  },
  noDosageInfo: {
    ko: '용량 정보 없음',
    en: 'No dosage info',
    fr: 'Dose non renseignée',
  },
  noIngredientInfo: {
    ko: '성분 정보 없음',
    en: 'No ingredient info',
    fr: 'Aucun ingrédient',
  },
  supplementNeedsIngredient: {
    ko: '성분 확인 필요',
    en: 'Ingredient check needed',
    fr: 'Ingrédient à vérifier',
  },
  ...
  ingredientsPlaceholder: {
    ko: '예: 아스피린, EPA 및 DHA 함유 유지',
    en: 'e.g. Aspirin, EPA and DHA oil',
    fr: 'ex. aspirine, huile EPA et DHA',
  },
  reviewAllResults: {
    ko: '전체 인식 결과',
    en: 'All scan results',
  ...
  analyzeInteractions: {
    ko: '상호작용 분석하기',
    en: 'Analyze interactions',
    fr: 'Analyser les interactions',
  },
  analysisInProgress: {
    ko: '상호작용 분석 중',
    en: 'Analyzing interactions',
    fr: 'Analyse des interactions',
  },
  analysisSubtitle: {
  ...
  cannotLoadResult: {
    ko: '결과를 불러올 수 없어요',
    en: 'Unable to load the result',
    fr: 'Impossible de charger le résultat',
  },
  attentionPairs: {
    ko: '주의할 조합',
    en: 'Combinations to watch',
    fr: 'Combinaisons à surveiller',
  },
  recognizedItems: {
    ko: '인식한 항목',
    en: 'Scanned items',
  ...
  noPairs: {
    ko: '해당 조합이 없어요',
    en: 'No combinations here',
    fr: 'Aucune combinaison',
  },
  consultProfessional: {
  ...
  riskDangerTitle: {
    ko: '전문가 상담이 필요해요',
    en: 'Professional consultation needed',
    fr: 'Avis professionnel requis',
  },
  riskCautionTitle: {
    ko: '주의해서 확인해 주세요',
    en: 'Please check carefully',
    fr: 'À vérifier avec prudence',
  },
  riskSafeTitle: {
    ko: '중대한 주의사항 미탐지',
    en: 'No major warning found',
    fr: 'Aucune alerte majeure détectée',
  },
  dbCoverageTitle: {
    ko: 'DB 확인 결과',
    en: 'Database check',
  ...
  historyTitle: {
    ko: '분석 기록',
    en: 'Analysis history',
    fr: 'Historique d’analyse',
  },
  deleteRecords: {
    ko: '기록 삭제',
    en: 'Delete records',
    fr: 'Supprimer les historiques',
  },
  deleteRecordsMessage: {
    ko: '{count}개의 분석 기록을 삭제할까요?',
    en: 'Delete {count} analysis records?',
    fr: 'Supprimer {count} historiques d’analyse ?',
  },
  ...
  selectDeleteRecords: {
    ko: '삭제할 기록 선택',
    en: 'Select records to delete',
    fr: 'Sélectionnez les historiques à supprimer',
  },
  ...
  usedItemsTitle: {
    ko: '분석에 사용한 항목',
    en: 'Items used in this analysis',
    fr: 'Éléments utilisés pour l’analyse',
  },
  noAnalysisResult: {
    ko: '분석 결과가 없어요',
    en: 'No analysis result',
    fr: 'Aucun résultat d’analyse',
  },
  noRecognizedItems: {
    ko: '인식 기록 없음',
    en: 'No scanned items',
    fr: 'Aucun élément scanné',
  },
  unknownItem: {
    ko: '이름 없는 항목',
    en: 'Unnamed item',
  ...
  noUploadPhoto: {
    ko: '업로드할 사진이 없습니다.',
    en: 'There is no photo to upload.',
    fr: 'Aucune photo à téléverser.',
  },
  prescriptionServerUnavailable: {
  ...
  noPrescriptionFound: {
    ...
    en: 'No medicine name was found in the prescription or prescription bag.',
    fr: 'Aucun nom de médicament trouvé dans l’ordonnance ou le sachet.',
  },
  recognizedPrescription: {
    ko: '인식된 처방약',
    en: 'Scanned prescription medicine',
    fr: 'Médicament scanné',
  },
  recognizedSupplement: {
    ko: '인식된 건강기능식품',
    en: 'Scanned supplement',
    fr: 'Complément scanné',
  },
  noSupplementResult: {
  ...
  prescriptionBag: {
    ko: '처방전·약봉투',
    en: 'prescription or prescription bag',
    fr: 'ordonnance ou sachet',
  },
...
export function useI18n() {
  ...
  return {
    ...
    tx: useCallback(
      (text: string) => translateExact(language, text),
      [language],
    ),
  };
}
...
export function categoryLabel(
  category: '알약' | '건강기능식품 라벨',
  lang: AppLanguage,
  variant: 'short' | 'capture' = 'short',
) {
  if (category === '건강기능식품 라벨') return translate(lang, 'supplement');
  return variant === 'capture'
    ? translate(lang, 'prescriptionBag')
    : translate(lang, 'prescription');
}

export function riskLabel(
  level: 'danger' | 'caution' | 'safe' | undefined,
  lang: AppLanguage,
) {
